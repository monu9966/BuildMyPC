...
export default function Cart() {
    ...
    return (
        <div className="container">
            <h2><FaShoppingCart style={{ marginRight: "10px" }} /> My Cart</h2>
            ...
            {cart.map((item, i) => (
                <div className="cart-card" key={i}>
                    ...
                    <button onClick={() => removeFromCart(i)} style={{ backgroundColor: "#e74c3c" }}>
            ...
            <button onClick={() => navigate("/checkout", { state: cart })} style={{ backgroundColor: "#27ae60" }}>
